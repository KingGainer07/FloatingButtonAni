...
import com.project.floatingbuttonani.FloatingButtonView.OnActionSelectedListener;
...
public class FabWithLabelView extends LinearLayout {
    ...
    public void setActionItem(FloatingButtonActionItem actionItem) {
        ...
        if (actionItem.getFabType().equals(FloatingButtonActionItem.TYPE_FILL)) {
            ...
            FloatingActionButton newFab = view.findViewById(R.id.fab_fill);
            mFab = newFab;
        }
        ...
        if (labelColor == RESOURCE_NOT_SET) {
            labelColor = ResourcesCompat.getColor(getResources(), R.color.label_text_color,
                    getContext().getTheme());
        }
        setLabelColor(labelColor);
        int labelBackgroundColor = actionItem.getLabelBackgroundColor();
        if (labelBackgroundColor == RESOURCE_NOT_SET) {
            labelBackgroundColor = ResourcesCompat.getColor(getResources(), R.color.label_background_color,
                    getContext().getTheme());
        }
        setLabelBackgroundColor(labelBackgroundColor);
        if (actionItem.getFabSize() == SIZE_AUTO || actionItem.getFabType().equals(FloatingButtonActionItem.TYPE_FILL)) {
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        try {
            ...
            FloatingButtonActionItem.Builder builder = new FloatingButtonActionItem.Builder(getId(), src);
    ...
    private void setFabSize(@FloatingActionButton.Size int fabSize) {
        int normalFabSizePx = getContext().getResources().getDimensionPixelSize(R.dimen.fab_normal_size);
        int miniFabSizePx = getContext().getResources().getDimensionPixelSize(R.dimen.fab_mini_size);
        int fabSideMarginPx = getContext().getResources().getDimensionPixelSize(R.dimen.fab_side_margin);
