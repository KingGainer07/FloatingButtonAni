...
public class FloatingButtonActionItem implements Parcelable {
    ...
    private FloatingButtonActionItem(Builder builder) {
        mId = builder.mId;
    ...
    public static class Builder {
        ...
        /**
         * Creates a builder for a action item that uses a {@link DrawableRes} as icon.
         *
         * @param id               the identifier for this action item. The identifier must be unique to the instance
         *                         of {@link FloatingButtonView}. The identifier should be a positive number.
        ...
        /**
         * Creates a builder for a action item that uses a {@link Drawable} as icon.
        ...
        public FloatingButtonActionItem create() {
            return new FloatingButtonActionItem(this);
        }
    ...
    protected FloatingButtonActionItem(Parcel in) {
        this.mId = in.readInt();
    ...
    public static final Creator<FloatingButtonActionItem> CREATOR = new Creator<FloatingButtonActionItem>() {
        @Override
        public FloatingButtonActionItem createFromParcel(Parcel source) {
            return new FloatingButtonActionItem(source);
        }

        @Override
        public FloatingButtonActionItem[] newArray(int size) {
            return new FloatingButtonActionItem[size];
        }
    };
}
