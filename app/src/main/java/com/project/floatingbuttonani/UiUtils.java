...
public class UiUtils {
    ...
    public static void enlargeAnim(View view, long startOffset) {
        ...
        Animation anim = AnimationUtils.loadAnimation(view.getContext(), R.anim.scale_fade_and_translate_in);
    ...
    public static void shrinkAnim(final View view, long startOffset) {
        ViewCompat.animate(view).cancel();
        view.setVisibility(View.VISIBLE);
        Animation anim = AnimationUtils.loadAnimation(view.getContext(), R.anim.scale_fade_and_translate_out);
        anim.setStartOffset(startOffset);
